...
/**
 * Created by riceyu on 2016-11-02.
 */
...
public class ImageAnimation extends Activity implements SensorEventListener, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener{
...
//      parent = (LinearLayout) findViewById(R.id.parent);
    ...
    public class CustomDrawableView extends View{
        ...
        protected void onDraw(Canvas canvas) {
            ...
            circle.addCircle(250, 250, 100, Path.Direction.CW);

            canvas.drawTextOnPath("Hello", circle, 0, 30, p);


             canvas.drawCircle(250,250,100, p);
